...
export const renderTermsPage = (): string => {
  return renderPageLayout({
    title: "Terms of Service - GTM MCP Server by Pragmatic Growth",
    content: `
    <h1>Terms of Service</h1>

    <p><strong>Last updated:</strong> June 20, 2025</p>

    <p>Please read these Terms of Service ("Terms", "Terms of Service") carefully before using the GTM MCP Server by Pragmatic Growth (the "Service") operated by Pragmatic Growth ("Company", "us", "we", or "our").</p>
    ...
    <div class="highlight">
      <h2>7. Compliance with Google Policies and Limited Use Requirements</h2>
      ...
      <div class="warning">
        <p><strong>AI/ML Prohibition:</strong> We do not use any Google API data for AI/ML model training or improvement at all. This service operates as a middleware proxy without any artificial intelligence or machine learning functionality.</p>
      </div>
    </div>

    <div class="section">
      <h2>8. Content, Intellectual Property, and Links</h2>
      <ul>
    ...
    <div class="section">
      ...
      <ul>
        ...
        <li>Please use the following email address for dispute resolution purposes: <strong>serkan@pragmaticgrowth.com</strong></li>
    ...
    <div class="section">
      ...
      <ul>
        ...
        <li>Please use the following email address for support purposes: <strong>serkan@pragmaticgrowth.com</strong></li>
    ...
    <div class="contact">
      <p><strong>Pragmatic Growth</strong><br>
      Contact email address: <strong>serkan@pragmaticgrowth.com</strong></p>
      <p><strong>Last Updated:</strong> June 20, 2025</p>
    </div>
    `,
  });
