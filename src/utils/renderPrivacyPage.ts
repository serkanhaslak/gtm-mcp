...
export const renderPrivacyPage = (): string => {
  return renderPageLayout({
    title: "Privacy Policy - GTM MCP Server by Pragmatic Growth",
    content: `
    ...
    <h2>Overview</h2>
    <p>This privacy notice aims to give you information on how Pragmatic Growth ("we", "us", "our", the "Company") will collect and process personal data when you use the GTM MCP Server by Pragmatic Growth ("you", "your").</p>
    ...
    <p>GTM MCP Server by Pragmatic Growth processes the following categories of your personal data:</p>
    ...
    <div class="highlight">
      ...
      <p>GTM MCP Server by Pragmatic Growth has access to your Google Tag Manager accounts, containers, workspaces, and items within, so that MCP clients can use the service to interact with these items through our middleware proxy.</p>

      <div class="warning">
        <h3>AI/ML Model Training Prohibition</h3>
        <p><strong>Our application does NOT use Google Workspace or Tag Manager user data to train or improve AI/ML models at all.</strong> Specifically:</p>
      </div>
    ...
    <div class="contact">
      ...
      <p>For questions about this Privacy Notice or our data practices, please contact us at <strong>serkan@pragmaticgrowth.com</strong>.</p>
    </div>
